...
public class TokenUtils {
    ...
    public static String generateJwtToken(User user) {
        ...
        System.out.println("설정된 유효 시간(ms): " + tokenValidateTime);
        System.out.println("만료 예정 시간: " + expireTime);
    ...
    public static Long getTokenValidateTime() {
        return tokenValidateTime;
    }
